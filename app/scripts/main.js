...
(function(w, $) {
    ...
    w.Dadb = function(parentId, userOptions) {
        ...
        function _onOver(event, div) {
            ...
            if (blockParentId === parentId) {
                ...
                if (hoveredDivs !== oldHoveredDivs) {
                    ...
                    hoveredDivs.DadbStep.forEach(function(entry) {
        ...
        function _createStampable() {
            ...
            $('div.DadbDraggableBlock[data-parentid="' + parentId + '"]').unbind('click').click(function(e) {
                ...
                if ($(this).hasClass('Stamp')) {
                    ...
                    // if the click was near the sellected arrea add a blocks!!!
                    $(document).click(function(e) {
                        ...
                        if (_options.dragDiv) {
                            ...
                            // else {
                            // 		// the click was far far away
                            //     _options.dragDiv.effect('shake', {
                            //         distance: 6,
                            //         times: 3
                            //     }, 200);
                            // }
                            // Stop hovering (TODO dragging) if an element was successfully dropped.
                            _removeHighlight();
                        }
                        return;
                    });
        ...
        function _removeHighlight() {
            $('div.DadbStep').removeClass('DadbHighlightNOK').removeClass('DadbHighlightOK');
        }
